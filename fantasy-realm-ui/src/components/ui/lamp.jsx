...
return (
    ...
    <div
        className="relative flex w-full flex-1 translate-y-80 scale-y-160 items-center justify-center isolate z-0 ">
        <motion.div
        ...
        className="absolute inset-auto z-30 h-20 w-10 -translate-y-[6rem] rounded-full bg-cyan-400 blur-2xl"></motion.div>
        <motion.div
        initial={{ width: "15rem" }}
